  ...
  return (
    <div>
      ...
      <div class="container-fluid">
          <div class="row">
              <div class="col-md-3">
                  <h5 style={{color:'white'}}><b><i>Location</i></b></h5>
                  <p>112 Main St, Surat, Gujarat</p>
                  <i class="fas fa-map-marker-alt"></i> 
              </div>
              <div class="col-md-3">
                  <h5 style={{color:'white'}}><b><i>Contact</i></b></h5>
                  <p>Email: example@example.com</p>
                  <p>Phone: +1234567890</p>
                  <i class="fas fa-envelope"></i> <i class="fas fa-phone"></i>
              </div>
              <div class="col-md-3">
                <h5 style={{color:'white'}}><b><i>Links</i></b></h5>
                <div> <a href="#carouselExample" style={{color:'antiquewhite'}}>Home</a></div>
               <div> <a href="#about" style={{color:'antiquewhite'}}>About</a></div>
                ...
                <div><a href="#book" style={{color:'antiquewhite'}}>Book</a></div>

            </div>
            <div class="col-md-3">
                  <h5 style={{color: 'white'}}><b><i>Social Media</i></b></h5>
                  <p>Follow us:</p>
                    <FaFacebook />
                    <FaTwitter />
                    <FaInstagramSquare />
